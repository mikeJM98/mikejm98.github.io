...
if(isset($_POST['boton'])){ 
    ...
    if ((($_FILES["archivo"]["type"] == "image/gif") || ($_FILES["archivo"]["type"] == "image/jpeg") || ($_FILES["archivo"]["type"] == "image/png")) && ($_FILES["archivo"]["size"] < 500000)) { 
        ...
        if ($_FILES["archivo"]["error"] > 0) { 
            ...
            if (file_exists("archivos/" . $_FILES["archivo"]["name"])) {           
                ...
                move_uploaded_file($_FILES["archivo"]["tmp_name"], "../asset/raul/imagenes/" . $_FILES["archivo"]["name"]);           
                echo "Archivo Subido ";           
                echo "<img src='../asset/raul/imagenes/".$_FILES["archivo"]["name"]."'>";         
            }
        }
    } else {
